...
| PUT     | **使用请求中的负载创建或者替换目标资源**<br>请求主体 YES<br/>响应主体 NO<br/>安全性 NO<br/>幂等性 YES<br/>可缓存 NO<br/>HTML 表单支持  NO |
